...
export const projects = [
  ...
  {
  id: 4,
  title: "SHIPLOGO (GoParcel)",
  subtitle: "Shipping rate comparison & booking platform",
  website: "ship.probeyservices.in",
  link: "https://ship.probeyservices.in",
  description:
    "A logistics aggregation platform that enables users to compare shipping rates across multiple courier partners and book shipments seamlessly with real-time tracking and automation.",
  features: [
    "Multi-carrier rate comparison (e.g., Delhivery, Bluedart, DTDC, etc.)",
    "Shipment booking with dynamic pricing and service selection",
    "Real-time tracking integration with courier APIs",
    "Order management dashboard with shipment lifecycle tracking",
    "Automated shipping label and invoice generation",
    "COD (Cash on Delivery) and prepaid shipment support",
    "Webhook-based tracking updates and status synchronization",
    "Address management and validation system",
    "Admin panel for monitoring shipments, users, and logistics performance",
  ],
  responsibilities: [
    "Developed backend architecture for shipment creation, rate fetching, and booking flow",
    "Integrated multiple third-party courier APIs for rate comparison and tracking",
    "Designed database schema for shipments, orders, and tracking history",
    "Implemented webhook handling for real-time shipment status updates",
    "Built secure APIs for order creation, label generation, and tracking",
    "Handled edge cases like failed bookings, retries, and courier fallbacks",
  ...
  image: "/assets/shipping.jpg", // you can replace with actual screenshot later
  featured: true,
},
  {
    id: 5,
