...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div className="bg-[#111111] rounded-2xl p-8 border border-gray-800 mb-8 hover:border-gray-700 hover:-translate-y-1 hover:shadow-xl transition-all">
      <div className="mb-6">
        {project.featured && (
          <span className="inline-block px-3 py-1.5 bg-blue-900/30 text-blue-400 rounded-full text-xs font-semibold mb-4">
            Featured
          </span>
        )}
        <h3 className="text-2xl md:text-3xl font-bold mb-3">{project.title}</h3>
        <p className="text-gray-400 mb-4 text-lg">{project.subtitle}</p>
      ...
      <button
        ...
        className="text-blue-400 text-sm font-semibold mt-4 hover:text-blue-300 transition-colors bg-transparent border-none cursor-pointer p-0"
      >
